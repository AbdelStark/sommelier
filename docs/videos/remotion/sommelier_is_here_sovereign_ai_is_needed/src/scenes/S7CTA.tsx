...
const OPEN_WORDS = ['Open code.', 'Open weights.', 'Open data.', 'Open evidence.'];
  ...
  return (
    <Stage tint="rgba(185, 61, 88, 0.14)">
      ...
      >
        ...
        <div style={{display: 'flex', gap: '0.55em', fontSize: 44, fontWeight: 700}}>
          {OPEN_WORDS.map((w, i) => {
            const e = spring({
              frame,
              fps,
            ...
            return (
              <span
                ...
                style={{
                  ...
                  color: i === OPEN_WORDS.length - 1 ? colors.wineBright : colors.ink,
                }}
              >
                {w}
              </span>
